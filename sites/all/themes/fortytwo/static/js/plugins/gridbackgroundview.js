    ...
    Drupal.behaviors.showGrid = {
        attach: function ( context, settings ) {
            ...
            if( $( 'body' ).hasClass( 'show-grid' )) {
                if( window.matchMedia ) new gridBackgroundView({ el: $( '#svg-grid-background' ) })
                else {
    ...
    function gridBackgroundView( options ) {
        var view = {
            ...
            _setLayoutType: function() {
                ...
                var body = $( "body" );
                if( body.hasClass( 'layout-adaptive' )) view.defaults.layout = { fluid: false, adaptive: true };
                else if( body.hasClass( 'layout-fluid' )) view.defaults.layout = { fluid: true, adaptive: false }
            },
            ...
            _getPercentages: function() {
                ...
                return { width: newColumnWidth, gutter: newGutter, canvasWidth: canvasWidth };
            }
        };
